...
/**
 * Styled native <select>. We intentionally use the native control (rather than
 * a Radix popover) so it works seamlessly inside server-action <form> posts
 * and requires no client state.
 */
