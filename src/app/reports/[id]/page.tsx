    ...
    <div className="min-h-screen bg-muted/30">
      ...
      <div className="mx-auto max-w-5xl px-4 py-8 md:px-8">
        ...
        <footer className="flex flex-col items-center gap-2 pb-8 text-center text-xs text-muted-foreground">
          <Link href="/" aria-label="srchr home"><Logo /></Link>
          <p>Generated by srchr · {formatDate(report.completedAt ?? report.createdAt)}</p>
...
function SectionHeader({
  ...
  return (
    <div className="mb-4 flex items-start gap-3">
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-brand-blueDark">
        <Icon className="h-5 w-5" />
      </div>
      <div>
...
function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 p-8 text-center">
      ...
      <p className="max-w-md text-muted-foreground">This audit doesn&apos;t exist or has expired. Start a new audit to find the leaks in your search funnel.</p>
